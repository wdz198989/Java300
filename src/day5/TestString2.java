...
public class TestString2 {
	...
	public static void main(String[] args) {
	        ...
	        s = s4.substring(4);//提取子字符串：从下标为4的开始到字符串结尾为止
	        System.out.println(s);
	        s = s4.substring(4, 7);//提取子字符串：下标[4, 7) 不包括7
	        System.out.println(s);
	        ...
	        s = s5.trim();//去除字符串首尾的空格。注意：中间的空格不能去除
	        System.out.println(s);
	        System.out.println(s5);//因为String是不可变字符串，所以s2不变
